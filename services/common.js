...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'abhishekkumar65856@gmail.com', // gmail
...
exports.sendMail = async function ({to, subject, text, html}){
    let info = await transporter.sendMail({
        from: '"Shopping-Center" <abhishekkumar65856@gmail.com>', // sender address
        to,
        subject,
        text,
        html
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="abhishekkumar65856@gmail.com">contact us</a>.</p>
            </td>
          </tr>
          <!-- end copy -->
